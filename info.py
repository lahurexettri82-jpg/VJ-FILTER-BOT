...
API_ID = int(environ.get('API_ID', '23737894'))
API_HASH = environ.get('API_HASH', 'e47d717b7d807f0276a1c18f08281778')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6896472255').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002655747856'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', ' -1002995319070').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://<db_username>:<db_password>@samirff.7mtrrk7.mongodb.net/?retryWrites=true&w=majority&appName=Samirff")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/SRP_Movies_Request_Group')
